cool.util.initPackages("cool.ui.common");

cool.util.extend("cool.ui.common.Component", "Object", [], function(){
    this.targetId;
    this.container;
    this.model;

    this.placeAt = function(targetId) {
        this.container = $("#" + targetId);
        this.beforeRender();
        this.render();
        this.afterRender();
    }
...
cool.util.extend("cool.ui.form.Field", "cool.ui.common.Component", [], function(){
...
cool.util.extend("cool.ui.form.ImageViewer", "cool.ui.form.Field", [], function() {
    this.imgTagId = "";
    this.fileTagId = "";
    this.hint = "";
